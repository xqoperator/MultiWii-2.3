...
void LoadDefaults() {
  uint8_t i;
  ...
  #else
	  #if PID_CONTROLLER == 1
      conf.pid[ROLL].P8     = 80;  conf.pid[ROLL].I8    = 30; conf.pid[ROLL].D8     = 23;
      conf.pid[PITCH].P8    = 80; conf.pid[PITCH].I8    = 30; conf.pid[PITCH].D8    = 23;
    ...
    conf.yawRate = 0;
    conf.dynThrPID = 0;
    conf.thrMid8 = 50; conf.thrExpo8 = 60;
